...
const Navbar = () => {
    return (
        <>
            <div className="container-fluid nav_bg " style={{position:"fixed", zIndex:1000, top:0}}>
                <div className="row">
                    <div className="col-10 mx-auto">
                        <nav className="navbar navbar-expand-lg navbar-light">
                            <div className="container-fluid">
                                <NavLink  exact className="navbar-brand" to="/fashionview"><b>FASHIONINSTA</b></NavLink >
